...
export function ChangeMachine() {
  ...
  const handleCreateDrawing = (params, successCallback) => {
    ...
    axios.post("http://kate.fly.dev/drawings.json", params).then((response) => {
  ...
  const handleCreateImage = (params, successCallback) => {
    ...
    axios.post(`http://kate.fly.dev/images.json`, params).then((response) => {
  ...
  const handleUpdateDrawing = (id, params, successCallback) => {
    ...
    axios.patch(`http://kate.fly.dev/drawings/${id}.json`, params).then((response) => {
      setDrawings(
  ...
  const handleDestroyDrawing = (drawing) => {
    ...
    axios.delete(`http://kate.fly.dev/drawings/${drawing.id}.json`).then((response) => {
  ...
  const handleDestroyImage = (image) => {
    ...
    axios.delete(`http://kate.fly.dev/images/${image.id}.json`).then((response) => {
